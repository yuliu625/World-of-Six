...
def get_save_path(beta: float, price_index: int = 0):
    ...
    if beta == 0.25:
        return dir_to_save_025 + rf"/sequence_price"
    elif beta == 0.75:
        return dir_to_save_075 + rf"/sequence_price"
...
async def main(
    ...
    tasks = []
    network_effect_with_prices_list = prices_list_factory.get_sequence_price()
